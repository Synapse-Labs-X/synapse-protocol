...
import UserTransactionButton from "./UserTransactionButton";
import WalletStatusIndicator from "./WalletStatusIndicator";
import { Agent } from "@/types/agent";

interface StatusBarWithTransactionsProps {
  balance: number;
  network: string;
...
const StatusBarWithTransactions: React.FC<StatusBarWithTransactionsProps> = ({
  balance,
  network,
  transactionCount,
  mainAgent,
  ...
  // Handle balance update from TopUpButton or UserTransactionButton
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-800 border-b border-gray-700">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        {/* User Transaction Button - Send funds from user wallet to Synapse */}
        <UserTransactionButton
          onTransactionComplete={handleBalanceUpdate}
          currentBalance={balance}
        />

        {/* Add TopUpButton for Crossmark wallet integration */}
        <TopUpButton
...
export default StatusBarWithTransactions;
