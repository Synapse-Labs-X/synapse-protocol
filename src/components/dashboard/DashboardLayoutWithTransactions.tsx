...
const DashboardLayoutWithTransactions: React.FC<
  DashboardLayoutWithTransactionsProps
> = ({
  network,
  transactions,
  balance,
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <header className="relative z-10 backdrop-blur-md bg-gray-900/80 border-b border-gray-700/50">
        ...
        {/* Status Bar with user transaction functionality */}
        <StatusBarWithTransactions
          balance={balance}
          network="XRP Testnet"
...
export default DashboardLayoutWithTransactions;
