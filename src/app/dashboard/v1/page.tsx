...
export default function DashboardPageWithTransactions() {
  // State management
  ...
  useEffect(() => {
    ...
    // Initialize user transaction service
    userTransactionService.initialize().catch(console.error);
  }, []);
      ...
      const initialNodes: Agent[] = [
        {
          ...
          cost: 0,
          status: "active",
          walletAddress: userTransactionService.getMainWalletAddress(), // Use address from service
        },
        {
          id: "text-gen-1",
          name: "Text Generator",
  ...
  // Handler for balance updates from Crossmark wallet or user wallet
  ...
  return (
    <ClientSideOnly>
      ...
      <DashboardLayoutWithTransactions
        network={network}
